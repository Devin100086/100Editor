import numpy as np
import torch
from EditorGS.GUIEditor.utils.deform_utils import cal_laplacian, cal_connectivity_from_points,\
      produce_edge_matrix_nfmt, lstsq_with_handles, cal_verts_deg, rigid_align
from EditorGS.GUIEditor.utils.other_utils import matrix_to_quaternion
