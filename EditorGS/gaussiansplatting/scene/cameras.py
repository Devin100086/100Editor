...
import numpy as np
from EditorGS.gaussiansplatting.utils.graphics_utils import getWorld2View2, getProjectionMatrix, focal2fov, fov2focal,getWorld2View2_tensor
...
class CustomCam:
    def __init__(self, width, height, fovy, fovx, R, T, extr, znear=0.01, zfar=10):
        self.image_width = width
        self.image_height = height
        self.FoVy = fovy
        self.FoVx = fovx
