import numpy as np
import torch
from editor.hundrededitor_gui.utils.deform_utils import cal_laplacian, cal_connectivity_from_points,\
      produce_edge_matrix_nfmt, lstsq_with_handles, cal_verts_deg, rigid_align
from editor.hundrededitor_gui.utils.other_utils import matrix_to_quaternion
...
if __name__ == "__main__":
    ...
    from editor.GUIEditor.utils.deform_utils import cal_arap_error
