...
import numpy as np
import os
from editor.hundrededitor_gui.utils.deform_utils import cal_connectivity_from_points, cal_arap_error, arap_deformation_loss
...
class ControlNodeWarp(nn.Module):
    ...
    def as_gaussians(self):
        if not hasattr(self, 'gs') or self.gs is None:
            ...
            from third_party.gaussiansplatting.scene.gaussian_model import GaussianModel, BasicPointCloud, StandardGaussianModel
    ...
    def as_gaussians_visualization(self):
        from third_party.gaussiansplatting.scene.gaussian_model import GaussianModel, BasicPointCloud
