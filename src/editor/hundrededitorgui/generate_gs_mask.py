...
from editor.hundrededitorgui.base import *
from editor.gaussiansplatting.gaussian_renderer import render
from editor.hundrededitorgui.utils import *
...
if __name__ == "__main__":
    default_drag_cache_dir = resolve_runtime_subdir(__file__, "cache", "drag", create=True)
    default_positive = (default_drag_cache_dir / "sam2_positive_points.npy").as_posix()
    default_negative = (default_drag_cache_dir / "sam2_negative_points.npy").as_posix()
    ...
    parser.add_argument(
        "--camera",
        type=str,
        default=(default_drag_cache_dir / "camera.pkl").as_posix(),
        help="camera.",
    )
