import torch
from trainer.gsplat.config import Config
from typing import Dict, Optional, Tuple
import yaml
import sys
from trainer.gsplat.gsplatNetwork import GsplatNetwork
import time
import tqdm
from trainer.gsplat.datasets.colmap import Parser,Dataset
from trainer.gsplat.init import create_splats_with_optimizers
...
from trainer.gsplat.utils import AppearanceOptModule, CameraOptModule, set_random_seed
from gsplat.compression import PngCompression
from gsplat.rendering import rasterization
from gsplat.strategy import DefaultStrategy, MCMCStrategy
from torchmetrics.image.lpip import LearnedPerceptualImagePatchSimilarity
from trainer.gsplat.lib_bilagrid import (
    BilateralGrid,
    slice,
...
class Runner:
    ...
    def train(self):
        ...
        if gsplatNetwork.conn is not None:
            final_step = max_steps - 1
            final_sh_degree = min(final_step // cfg.sh_degree_interval, cfg.sh_degree)
            print("\nReached final iteration. Holding final result; click 'Pause Training' in UI to stop.")
            gsplatNetwork.render(
