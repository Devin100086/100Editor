...
python EditorGS/GUIEditor/eval.py --clip_prompt_origin "${CLIP_PROMPT_ORIGIN}" --clip_prompt_target "${CLIP_PROMPT_TARGET}" --origin_gs_source ${ORIGIN_GS_SOURCE} --edited_gs_source  ${EDITED_GS_SOURCE} --colmap_dir ${COLMAP_DIR} --use_original_resolution ${USE_ORIGIN}