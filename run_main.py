...
def main():
    ...
    parser.add_argument("--data_path", help="root path for .ply files", default="/home/wucunqi/Desktop/results/face/3DGS+depth/point_cloud/iteration_7000/point_cloud.ply")
