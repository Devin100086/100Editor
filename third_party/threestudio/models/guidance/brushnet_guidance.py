...
class BrushNetGuidance(BaseObject):
    ...
    class Config(BaseObject.Config):
        ...
        pretrained_model_name_or_path: str = "runtime/.cache/brushnetX/base_model/realisticVisionV60B1_v51VAE"
    ...
    def configure(self) -> None:
        ...
        brushnet_name_or_path: str = "runtime/.cache/brushnetX"
